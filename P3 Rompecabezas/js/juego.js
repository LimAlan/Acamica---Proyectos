...
var instrucciones = ["Ordena las piezas para armar el rompecabezas", "Move las piezas con las flechas para lograr el objetivo"];
...
function ultimaDireccion(ultimaDireccion) {
...
function mostrarCartelGanador() {
  if (chequearSiGano()) {
    alert("Felicitaciones, ganaste! \nLo hiciste en " + movimientos.length + " movimientos.");
  }
